...
export type DownloadHandlerOptions = 'downloadStart' | 'currentDownloadVideoId' | 'downloadCancel'

export const DOWNLOAD_NAMESPACE = 'fileDonload'
export const DOWNLOAD_START: DownloadHandlerOptions = 'downloadStart'
export const DOWNLOAD_CANCEL: DownloadHandlerOptions = 'downloadCancel'
...
export const fileDownloadApi: ICommunicatorApi = {
  ...
  handlers: [DOWNLOAD_START, CURRENT_DOWNLOAD_VIDEO_ID, DOWNLOAD_CANCEL],
